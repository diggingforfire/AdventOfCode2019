...
namespace _02._02
{
    class Program
    {
        ...
        /// Still pretty straightforward. To avoid re-use of memory, the array of instructions is (shallowly) cloned with ToArray().
        /// I did consider object.Clone() since it's more explicit, but it requires a cast back to int[].
        /// </summary>
        static void Main()
        {
